 ...
 */
@Data
@SceneCardTaskExclusiveFields(targetClass = UpdateSceneCardTaskReqVO.class)
@ApiModel(description = "修改场景卡片任务请求VO")
public class UpdateSceneCardTaskReqVO {

    @Pattern(regexp = "RIGHT_NOW|AT_TIME", message = "执行计划支持(RIGHT_NOW:立即、AT_TIME:定时)")
    @ApiModelProperty(value = "执行计划支持(RIGHT_NOW:立即 AT_TIME:定时)",
